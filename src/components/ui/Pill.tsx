...
const STYLES: Record<string, string> = {
  ...
  rejected: "bg-cognac-deep/10 text-cognac-deep border-cognac-deep/30",
  invited: "bg-canvas-2 text-ink-45 border-line-strong",
  active: "bg-[#3f6b4a]/10 text-[#3f6b4a] border-[#3f6b4a]/30",
  suspended: "bg-cognac/10 text-cognac-deep border-cognac/30",
